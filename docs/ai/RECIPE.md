# AIGC demo with Agora RTC

## Overview

Run an Agora RTC demo that combines real-time media with AI-generated content workflows.

Use this recipe when you want a working reference for RTC media session, AIGC flow, app credentials, browser runtime.

Repository: [AgoraIO-Community/Agora-AIGCDemo](https://github.com/AgoraIO-Community/Agora-AIGCDemo)
...
```text
You are working in `AgoraIO-Community/Agora-AIGCDemo`. Add or adapt this sample so a developer can run the aigc demo with agora rtc end to end with Agora RTC.
