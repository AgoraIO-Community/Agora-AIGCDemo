...
class STTModulesTestingVC: UIViewController, AgoraAIGCServiceDelegate, RtcManagerDelegate, MainViewDelegate {
    ...
    func rtcManagerOnCaptureAudioFrame(data: Data, isLast: Bool) {
        service.pushSpeechDialogue(with: data, vad: .nonMute, isLastFrame: false)
    }
